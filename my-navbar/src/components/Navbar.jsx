...
import smallSearchIcon from '../assets/작은돋보기.png'
import mainHomeIcon from '../assets/레이어 1.png'
import musicNoteIcon from '../assets/music-note-01.png'
import Dropdown from './Dropdown'
import TravelBagDropdown from './TravelBagDropdown';
import dropdownIcon from '../assets/화살표.png'
...
const NavbarLogo = styled.div`
  ...
  .mainHome {
    width: 132px;
    height: 28px;
    background-image: url(${mainHomeIcon});
...
const SearchIcon = styled.div`
  width: 24px;
  height: 24px;
  background-image: url(${smallSearchIcon});
  background-size: contain;
  background-repeat: no-repeat;
  background-position: center;
  cursor: pointer;
...
const MusicIcon = styled.div`
  ...
  height: 20px;
  margin-right: 8px;
  background-image: url(${musicNoteIcon});
  background-size: contain;
  background-repeat: no-repeat;
  background-position: center;
